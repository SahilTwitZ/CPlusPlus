...
// inline int getMax(int& a, int& b){ //inline function ==> performace a6i ho rhi hai , no extra memory usage, no function call overhead
//     return (a>b)?a:b;
// }
// int main(){
//     int a = 1,b = 2;
...
// void print(int arr[], int n, int start=0){//Condition --> hmesha last parameter se start karna default banana
