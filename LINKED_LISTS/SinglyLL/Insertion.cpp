...
void InsertAtHead(Node * & tail,Node* &head, int d){//why reference  ?  change in original linked list(no copy creation)
...
void InsertAtTail(Node* &tail, Node * & head,int d){//why reference  ?  change in original linked list(no copy creation)
