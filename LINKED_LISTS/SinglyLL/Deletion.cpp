...
void InsertAtHead(Node* &head, int d){//why reference  ?  change in original linked list(no copy creation)
...
void InsertAtTail(Node* &tail, int d){//why reference  ?  change in original linked list(no copy creation)
